...
function s.damtg2(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetChainLimit(Kirafan8.mychainlimit)
	Duel.Hint(HINT_MESSAGE,1-tp,aux.Stringid(10041020,2))
end
...
function s.damtg3(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.Hint(HINT_MESSAGE,1-tp,aux.Stringid(10041020,3))
end
...
function s.damtg4(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.Hint(HINT_MESSAGE,1-tp,aux.Stringid(10041020,4))
end
...
function s.bossdamcon5(e,tp,eg,ep,ev,re,r,rp)
	...
	and ((c:GetDefense()<=15 and (main:IsSetCard(0xd04) or main:IsSetCard(0xd03))) or (c:GetDefense()<=10 and (main:IsSetCard(0xd01) or main:IsSetCard(0xd02) or main:IsSetCard(0xd03))))
end
...
function s.damop5(e,tp,eg,ep,ev,re,r,rp)
	...
	c:RemoveCounter(tp,0xb01,c:GetCounter(0xb01),REASON_EFFECT)
	c:RemoveCounter(tp,0xb02,c:GetCounter(0xb02),REASON_EFFECT)
	c:RemoveCounter(tp,0xb03,c:GetCounter(0xb03),REASON_EFFECT)
	c:RemoveCounter(tp,0xb04,c:GetCounter(0xb04),REASON_EFFECT)
	c:RemoveCounter(tp,0xb05,c:GetCounter(0xb05),REASON_EFFECT)
	c:RemoveCounter(tp,0xb06,c:GetCounter(0xb06),REASON_EFFECT)
	...
	c:RegisterEffect(e1)
	if deckcount<10 then
	Duel.DiscardDeck(tp,deckcount,REASON_EFFECT)
	Duel.SendtoDeck(refill,nil,SEQ_DECKSHUFFLE,REASON_RULE)
	Duel.DiscardDeck(tp,10-deckcount,REASON_EFFECT)
	else
	Duel.DiscardDeck(tp,10,REASON_EFFECT) end
	c:AddCounter(0xd19,1)
	c:AddCounter(0xd01,1)
	Kirafan6.hungerop(e,tp,eg,ep,ev,re,r,rp)
end
function s.cannotcounter(e,c,tp,ctype)
	return ctype==0xb01 or ctype==0xb02 or ctype==0xb03 or ctype==0xb04 or ctype==0xb05 or ctype==0xb06 or ctype==0xb08
end
...
function s.damtg6(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e1:SetValue(-1)
	c:RegisterEffect(e1)
	elseif (main:IsSetCard(0xd04) and extraatk<=2) or (main:IsSetCard(0xd03) and extraatk<=3)
	...
	Duel.Hint(HINT_MESSAGE,1-tp,aux.Stringid(10041020,6))
end

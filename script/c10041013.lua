...
function s.bosstg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.Hint(HINT_MESSAGE,1-tp,aux.Stringid(10041014,7))
end
...
function s.resetop2(e,tp,eg,ep,ev,re,r,rp)
	...
	local a=0
	while a<=20 do
    cardamon1=Duel.CreateToken(tp,10041014)
	cardamon2=Duel.CreateToken(tp,10041015)

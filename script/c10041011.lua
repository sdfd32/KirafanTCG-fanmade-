...
function s.atkop(e,tp,eg,ep,ev,re,r,rp)
    ...
    local enemy=Duel.GetMatchingGroup(Kirafan6.NoEmFzonefilter,1-tp,0,LOCATION_MZONE,nil)
    ...
    elseif e:GetHandler():GetCounter(0xd05)==1 then
    ...
    elseif e:GetHandler():GetCounter(0xd07)==1 then
    ...
    elseif e:GetHandler():GetCounter(0xd06)==1 then

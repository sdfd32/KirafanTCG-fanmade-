...
function s.initial_effect(c)
	...
	e1:SetCondition(function(e) return e:GetHandler():GetDefense()<=3 and e:GetHandler():GetCounter(0xb08)==0 end)
	e1:SetValue(-1)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	e2:SetCondition(function(e) return e:GetHandler():GetDefense()>=7 and e:GetHandler():GetCounter(0xb08)==0 end)
	e2:SetValue(1)
	c:RegisterEffect(e2)	

...
function s.atkop(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(Card.IsRace,tp,LOCATION_MZONE,0,nil,RACE_WARRIOR+RACE_FAIRY)
...
function s.damop(e,tp,eg,ep,ev,re,r,rp)
	...
	local dam=1
	if Duel.GetMatchingGroupCount(Card.IsRace,tp,LOCATION_MZONE,0,nil,RACE_SPELLCASTER)==0 then dam=2 end
